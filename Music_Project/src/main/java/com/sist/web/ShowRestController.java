...
//	    }
    ...
    public String show_detail(int sno) throws Exception
    {
	...
	//후기
	public String commonsReplyData(int sno) throws Exception
   {
	   ObjectMapper mapper=new ObjectMapper();
	   List<ReplyVO> list=service.showreplyListData(sno);
	   String json=mapper.writeValueAsString(list);
    ...
    @PostMapping(value="show/reply_insert_vue.do",produces = "text/plain;charset=UTF-8")
